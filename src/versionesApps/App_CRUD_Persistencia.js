...
export default function App() {
  ...
  return (
    ...
    <View style={globalStyles.container}>
      ...
      {/* INTERRUPTOR INTELIGENTE PARA MOSTRAR O NO EL FORMULARIO */}
      {mostrarFormulario && (
        <ContactoForm
      ...
      {/* CONTENEDOR EN FILA PARA EL BOTON + JUNTO A BUSCAR */}
      ...
      <View style={globalStyles.containerBusquedaYMas}>
        ...
        />
        {/*BOTON MAS [+] */}
        {/* Aplicamos un array cuando usamos propiedades en el estilo. 1ero el externo y luego la propiedad */}
        <TouchableOpacity
          style={[
            globalStyles.botonMas,
            { backgroundColor: mostrarFormulario ? "#ef233c" : "#2A6F97" },
          ]}
          onPress={() => setMostrarFormulario(!mostrarFormulario)} // Commuta entre true y false
        >
          <Text style={globalStyles.TextoBorrarYMas}>
            {mostrarFormulario ? "❌" : "➕"}{" "}
            {/* Cambiamos el icono segun el estado de mostrarFormulario */}
          </Text>
        </TouchableOpacity>
      </View>
